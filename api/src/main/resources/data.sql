...
INSERT INTO ROLE(ID,ACTIVE,DESCRIPTION,PERMISSIONS,TIME_STAMP,TITLE,BRANCH_CREATED_FOR_ID,COMPANY_CREATED_FOR_ID,CREATED_BY_ID,MODIFIED_BY_ID)
VALUES(178,TRUE,'User is a service provider with no additional duty','R_APPTS,R_SVCS_ALL,R_CLS_BR',NULL,'SERVICE PROVIDER',300,500,1200,1201);

INSERT INTO USER_ROLE(ID,ACTIVE,TIMESTAMP,USER_ID,BRANCH_ID,COMPANY_ID,ROLE_ID) VALUES (777, TRUE,NULL,1200,300,500,177 );
