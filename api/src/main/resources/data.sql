...
VALUES(500,true,'Welcome to Urban Day Spa!','Beauty/Health','Urban Day Spa, with 2 locations in the Greater Houston Area','Urban Spa Day','support@urbandayspa.com','832-698-1544','https://clients.mindbodyonline.com/studios/UrbanDaySpaSpringTX/logo.gif','urbandayspa','https://urbandayspa.com/',2000,100);
...
VALUES(1600,'2022-05-30','08:00,15:00','08:00,15:00','08:00,11:00','closed','08:00,15:00','08:00,15:00','08:00,15:00',null,500,null,null);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
...
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1622,'2030-01-30','default','default','08:00,18:00','default','default','default','default',300,500,null,null);

INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1640,'2021-01-30','closed','default','default','default','default','default','default',301,500,null,null);

INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1650,'2023-12-20','08:00,12:00,13:00,18:00','08:00,12:00','closed','closed','closed','08:00,11:59','10:00,12:00',300,500,1000,1100);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
...
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1654,'2021-01-22','closed','closed','closed','closed','closed','closed','closed',300,500,1002,1100);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1655,'2022-04-30','07:07,12:07,13:00,18:00','07:00,12:00','13:00,22:00','07:00,12:00','19:00,22:00','07:00,12:00','07:00,12:00',300,500,1002,1100);
...
-------
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_BR',TRUE,'User can create a new branch for the company',null,'Create A New Branch' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'R_APPTS_ALL',TRUE,'User can read all appointments',null,'Read all appointments' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_APPTS_ALL',TRUE,'User can read and manage all future appointments',null,'Read and manage all future appointments' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'R_APPTS_OWN',TRUE,'User can read all appointments',null,'Read own appointments' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_APPTS_OWN',TRUE,'User can read and manage all future appointments',null,'Read and manage own future appointments' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'R_SVCS_ALL',TRUE,'User can read all appointments',null,'Read all services' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_SVCS_ALL',TRUE,'User can read and manage all future appointments',null,'Read and manage all services' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'R_WRK_HRS',TRUE,'User can read company work hours schedule',null,'Read company work hours schedule' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_WRK_HRS',TRUE,'User can read/manage company work hours schedule',null,'Read/manage company work hours schedule' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'R_CLS_BR',TRUE,'User can read branchs all clients',null,'Read branchs all clients' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'R_CLS_CO',TRUE,'User can read companys all clients',null,'Read companys all clients' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'R_CLS_OWN',TRUE,'User can read their own clients',null,'Read own clients' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_CLS_BR',TRUE,'User can read/manage branchs all clients',null,'Read/manage branchs all clients' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_CLS_CO',TRUE,'User can read/manage companys all clients',null,'Read/manage companys all clients' );
INSERT INTO PERMISSION(SHORT_TITLE,ACTIVE,DESCRIPTION,TIME_STAMP,TITLE) VALUES ( 'W_CLS_OWN',TRUE,'User can read/manage their own clients',null,'Read/manage own clients' );

INSERT INTO ROLE(ID,ACTIVE,DESCRIPTION,PERMISSIONS,TIME_STAMP,TITLE,BRANCH_CREATED_FOR_ID,COMPANY_CREATED_FOR_ID,CREATED_BY_ID,MODIFIED_BY_ID)
VALUES(177,TRUE,'User manages appointments','R_APPTS,W_APPTS,R_SVCS_ALL,W_SVCS_ALL,R_CLS_BR,W_CLS_BR',NULL,'REGISTRAR',300,500,NULL,NULL);
INSERT INTO ROLE(ID,ACTIVE,DESCRIPTION,PERMISSIONS,TIME_STAMP,TITLE,BRANCH_CREATED_FOR_ID,COMPANY_CREATED_FOR_ID,CREATED_BY_ID,MODIFIED_BY_ID)
VALUES(178,TRUE,'User is a service provider with no additional duty','R_APPTS,R_SVCS_ALL,R_CLS_BR,R_USRPF_BR',NULL,'SERVICE PROVIDER',300,500,1200,1201);
INSERT INTO ROLE(ID,ACTIVE,DESCRIPTION,PERMISSIONS,TIME_STAMP,TITLE,BRANCH_CREATED_FOR_ID,COMPANY_CREATED_FOR_ID,CREATED_BY_ID,MODIFIED_BY_ID)
VALUES(179,TRUE,'User is Administrator','R_USRPF_CO,W_USRPF_CO',NULL,'Administrator',NULL,NULL,NULL,NULL);

INSERT INTO USER_ROLE(ID,ACTIVE,TIMESTAMP,USER_ID,BRANCH_ID,COMPANY_ID,ROLE_ID) VALUES (777, TRUE,NULL,1200,301,500,177 );
-- INSERT INTO USER_ROLE(ID,ACTIVE,TIMESTAMP,USER_ID,BRANCH_ID,COMPANY_ID,ROLE_ID) VALUES (778, TRUE,NULL,1200,301,500,178 );

-- INSERT INTO USER_ROLE(ID,ACTIVE,TIMESTAMP,USER_ID,BRANCH_ID,COMPANY_ID,ROLE_ID) VALUES (779, TRUE,NULL,1201,NULL,500,179 );
INSERT INTO USER_ROLE(ID,ACTIVE,TIMESTAMP,USER_ID,BRANCH_ID,COMPANY_ID,ROLE_ID) VALUES (780, TRUE,NULL,1201,300,500,178 );

-- INSERT INTO USER_USER_ROLES(USER_ID,USER_ROLES_ID) VALUES(1200,777);
-- INSERT INTO USER_USER_ROLES(USER_ID,USER_ROLES_ID) VALUES(1200,778);