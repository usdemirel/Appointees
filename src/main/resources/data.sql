...
INSERT INTO CUSTOM_DAYS(ID,CUSTOM_DATE,DAILY_WORK_HOURS,DATE_CREATED,REASON,BRANCH_ID,COMPANY_ID,SERVICE_PROVIDER_ID)
VALUES(602,'2020-12-31','08:00,13:00','2020-12-10T11:18','EARLY LEAVE BEFORE NEW YEARY',NULL,500,NULL);
INSERT INTO CUSTOM_DAYS(ID,CUSTOM_DATE,DAILY_WORK_HOURS,DATE_CREATED,REASON,BRANCH_ID,COMPANY_ID,SERVICE_PROVIDER_ID)
VALUES(603,'2020-12-31','08:00,13:00','2020-12-10T11:18','EARLY LEAVE BEFORE NEW YEARY',301,500,NULL);
INSERT INTO CUSTOM_DAYS(ID,CUSTOM_DATE,DAILY_WORK_HOURS,DATE_CREATED,REASON,BRANCH_ID,COMPANY_ID,SERVICE_PROVIDER_ID)
VALUES(604,'2020-12-30','08:00,13:00','2020-12-10T11:18','EARLY LEAVE BEFORE NEW YEARY',300,500,NULL);
INSERT INTO CUSTOM_DAYS(ID,CUSTOM_DATE,DAILY_WORK_HOURS,DATE_CREATED,REASON,BRANCH_ID,COMPANY_ID,SERVICE_PROVIDER_ID)
VALUES(605,'2020-12-30','08:00,13:00','2020-12-10T11:18','EARLY LEAVE BEFORE NEW YEARY',301,500,NULL);
INSERT INTO CUSTOM_DAYS(ID,CUSTOM_DATE,DAILY_WORK_HOURS,DATE_CREATED,REASON,BRANCH_ID,COMPANY_ID,SERVICE_PROVIDER_ID)
VALUES(606,'2021-01-01','08:00,13:00','2020-12-10T11:18','EARLY LEAVE BEFORE NEW YEARY',300,500,NULL);
INSERT INTO CUSTOM_DAYS(ID,CUSTOM_DATE,DAILY_WORK_HOURS,DATE_CREATED,REASON,BRANCH_ID,COMPANY_ID,SERVICE_PROVIDER_ID)
VALUES(607,'2021-01-01','08:00,13:00','2020-12-10T11:18','EARLY LEAVE BEFORE NEW YEARY',301,500,NULL);
...
VALUES(1599,'2020-05-30','08:00,15:00','08:00,15:00','08:00,15:00','closed','08:00,15:00','08:00,15:00','08:00,15:00',null,500,null,null);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1600,'2021-04-30','08:00,12:00,13:00,18:00','08:00,12:00,13:00,18:01','08:00,13:00','closed','08:00,12:00,13:00,18:04','08:00,12:00,13:00,18:05','08:00,12:00,13:00,18:06',null,500,null,null);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1601,'2021-04-30','08:00,16:00','default','closed','default','default','default','default',300,500,null,null);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1602,'2030-01-30','08:00,16:00','default','default','default','default','default','default',300,500,null,null);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1603,'2025-04-30','08:00,16:00','default','default','default','default','default','default',300,500,null,null);




INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1604,'2021-04-30','08:00,12:00','08:00,12:00',null,null,'08:00,12:00','default','default',300,500,1000,1100);
INSERT INTO WEEKLY_DEFAULT_WORK_HOURS(ID,EFFECTIVE_BY,FRIDAY,MONDAY,SATURDAY,SUNDAY,THURSDAY,TUESDAY,WEDNESDAY,BRANCH_ID,COMPANY_ID,SERVICE_ID,SERVICE_PROVIDER_ID)
VALUES(1605,'2021-04-30','12:30,16:00','12:30,16:00','default','default','12:00,14:00',null,null,300,500,1001,1100);
